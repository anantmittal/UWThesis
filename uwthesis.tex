...
%
\Title{EF Math Activies to Improve metacognition.}
\Author{Anant Mittal}
\Year{2024}
\Program{Computer Science}

\Chair{Zoran Popovi\'{c}}{Professor}{Department of Computer Science}
\Signature{Zoran Popovi\'{c}}
\Signature{Yun-En Liu}
\Signature{etc}
...
%
\begin{glossary}
\item[Executive Function] Executive Function is a distinct set of skills imperative to school readiness and academic success. 
